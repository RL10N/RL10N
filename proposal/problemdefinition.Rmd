...
library(dplyr)
n_trans_data <- readRDS("../data/n_translations.rds")
...
```{r, NumberOfTranslations, echo = FALSE, fig.width = 9, fig.height = 6, fig.cap = "Figure 1: Number of translations in R packages."}
library(ggplot2)
