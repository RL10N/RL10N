...
R has been translated into [20 languages](http://developer.r-project.org/TranslationTeams.html) but currently not many packages have translations. Indeed of the 8274 packages on CRAN (actually, as mirrored on GitHub from CRAN), only 59 have any installed translations. **TODO: download all packages from CRAN, count how many have a po dir, and how many translations are in each; maybe draw a histogram.**
