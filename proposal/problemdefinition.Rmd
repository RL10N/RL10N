...
Further, the selection of languages that are translated to is relatively limited.  As Figure 3 shows ... **TODO: Once we have R User Group numbers (or other usage-of-r stats), pick out any languages with users but no translations.**
